...
\begin{table}[ht!]
  \begin{center}
    ...
    \end{tabular}
    \caption{
    \textbf{Simulations parameter recovery.}
    }
  \end{center}
\end{table}
...
\begin{centering}
  \begin{table}[ht]
    ...
    \begin{tabular}[ht]{ l | l | r | r }
      ...
      \hline
      Serotype & Interserotype & 0.105 & 0.547 & 0.660 \\ \hline
      Serotype & Equal null & 0.13 & 0.00 & 0.48 \\
      Serotype & Intrinsic null & 0.140 & 0.042 & 0.510 \\ \hline

      Gentoype & Interserotype & 0.062 & 0.286 & 0.666 \\
      Genotype & Intergenotype & 0.062 & 0.254 & 0.610 \\  \hline
