...
Alternatively, this lack of signal could also be explained by either (A) genotype-level frequency trajectories estimated from public data are overly noisy for this application or (B) our model of antigenic fitness based on PRNT assay does not match reality. In the present analysis, we are not able to firmly resolve these disparate possibilities.
