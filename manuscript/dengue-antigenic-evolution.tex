...
We take the training data and fit $d_b$ for each branch in the tree, subject to regularization as defined by the following constraints.
...
\begin{figure}[h]
  \begin{centering}
    ...
    At each increment, we use the predicted stepwise frequency change to adjust our estimates of antigenic fitness on a rolling basis (detailed in Methods).
