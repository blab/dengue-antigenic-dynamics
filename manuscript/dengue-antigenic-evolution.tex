...
% Titer model:
% * Limitations -- data resolution + limit of detection for inferring associated mutations, other sources of antigenic diversity not captured in PRNT50 assays, thresholding + putative underestimation
% * Strengths -- confirms and expands upon previous reports of within-serotype variation, suggests that clear genetic mechanisms exist, provides a framework for future investigation of driving mutations
...
% * Limitations -- enumerate model assumptions, possible sampling bias
% * Strengths -- directly quantifies the extent to which antigenic novelty drives real-world denv population dynamics, provides a framework for future investigation of other effects of population immunity (e.g., epidemic magnitude)
% * Context
