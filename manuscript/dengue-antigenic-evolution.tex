...
While most of these infections are asymptomatic or mild, ~1-3\% of cases progress to severe dengue hemorrhagic fever, causing approximately 10-15,000 deaths each year.
...
Thus, the antigenic relationships between dengue viruses -- the genetic and phenotypic determinants of whether the immune response generated after primary infection results in protection or enhancement of secondary infection -- are key drivers of DENV case outcomes and epidemic patterns.
...
Inferred intrinsic fitness values varied by a factor of \X-\X, with %serotype fitness order, in/consistent with experimental estimates of replicative fitness
