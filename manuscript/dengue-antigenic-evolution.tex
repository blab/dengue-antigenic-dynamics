...
% - Add both trend lines to geno/pheno graph

%%%%%%% TO DISCUSS %%%%%%%%%%%%
% - Perhaps redesign the serotype trajectory figure to better illustrate the rolling immunity calculation
% - How to update / display the antigenic tree? potential for misleading interpretation in terms of which clades are more closely related antigenically based on the genetic topologye trhe
