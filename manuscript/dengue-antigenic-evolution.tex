...
%%%%%%%% TO DO LIST %%%%%%%%%%
% - Add references
% - Shorten abstract to 150 words (for serious, elife!? >_> )
% - Add vertical grid lines to genotype tree fig, remove '_' from legend labels
% - Fix cbar label on genotype dtiter heatmap figure
% - One last audit of language use for "clade" vs "genotype" vs "serotype" vs "strain"
% - Read through of revised discussion, most recent revisions to results/methods/intro
% - Number equations, refer specifically as appropriate
