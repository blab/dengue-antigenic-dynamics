...
* Dengue exists as four phylogenetically distinct types, canonically thought of a serotypes.
* Each of these "serotypes" contains extensive genetic diversity.
* Individual "genotypes" (canonically identified clades within each serotype) have been associated with different disease outcomes, epidemic magnitudes, and vaccine-induced cross-protection.
* There is some evidence of antigenic heterogeneity, but it is not clear how this antigenic heterogeneity arises or what its importance is.
