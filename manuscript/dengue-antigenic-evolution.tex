...
While most of these infections are asymptomatic or mild, ~1-3\% of cases progress to severe dengue hemorrhagic fever (DHF), causing approximately 10-15,000 deaths each year.
...
\textbf{Strengths & implications}
We show that mapping antigenic change to individual branches in the DENV phylogeny is able to explain a large majority of the observed variation in antigenic phenotypes as measured by neutralization titers, suggesting that DENV antigenic evolution is closely coupled to genetic divergence.
...
The appearance of the deep antigenic divergence of the four serotypes, and the more recent antigenic divergences within each serotype, suggest that DENV antigenic evolution is likely an ongoing process.
...
\textbf{Strengths and limitations of the model}
% enumerate model assumptions
% possible sampling bias

\textbf{Impact of antigenic diversity on DENV population dynamics}
...
% directly quantifies the extent to which antigenic novelty drives real-world denv population dynamics, provides a framework for future investigation of other effects of population immunity (e.g., epidemic magnitude)

% null: within-serotype antigenic diversity really doesn't impact regional dynamics. If so, what other dynamics could this impact (e.g., viral fitness advantage, secondary case outcomes, vaccine efficacy)? Do we have reason to believe they impact these finer-scale dynamics? How could future studies address this?
...
% -- alt: this does effect broad population dynamics, but we can't see it because of the limited resolution of both antigenic + strain-specific incidence data
