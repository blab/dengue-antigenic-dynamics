...
This suggests that the 12 distinct antigenic phenotypes we identify here may have important impacts on secondary case outcome and vaccine efficacy.
...
We have provided all code, configuration files and datasets at `github.com/blab/dengue-antigenic-dynamics` to encourage future studies' use of this model as a mechanistic framework to further investigate the genetic drivers and extent of DENV antigenic heterogeneity once larger titer datasets become available.
...
DENV case outcomes are also mediated by XYZ immune interactions, the effects of which are not captured in neutralizaiton titers.
