...
if __name__=="__main__":
    ...
    args.add_argument('--gamma', type=float, help='Value or value range for the proportion of titers that wane per year post-exposure (slope of years vs. p(titers remaining))', default=1.85)
    args.add_argument('--sigma', type=float, help='Value or value range for -1*probability of protection from i conferred by each log2 titer unit against i', default=0.7)
    args.add_argument('--beta', type=float, help='Value or value range for beta. antigenic fitness = -1.*beta*population_immunity', default=3.)
    args.add_argument('--DENV1_f0', type=float, help='Relative intrinsic fitness value for DENV1', default = 1.)
    args.add_argument('--DENV2_f0', type=float, help='Relative intrinsic fitness value for DENV2', default = 1.)
    args.add_argument('--DENV3_f0', type=float, help='Relative intrinsic fitness value for DENV3', default = 0.7)
