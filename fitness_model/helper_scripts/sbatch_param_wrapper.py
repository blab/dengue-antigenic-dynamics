...
beta_vals = np.linspace(1.65,2.55,7) # center fine grid around "best" from coarse grid, +/- 0.45 on each side (7 points, 0.15 apart)
gamma_vals = np.linspace(0.85,1.75,7)
sigma_vals = np.linspace(0.3,1.2,7)
