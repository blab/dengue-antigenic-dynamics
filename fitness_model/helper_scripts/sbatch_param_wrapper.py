...
beta_vals = np.linspace(2.1,3,7) # center fine grid around "best" from coarse grid, +/- 0.45 on each side (7 points, 0.15 apart)
gamma_vals = np.linspace(0.4,1.3,7)
sigma_vals = np.linspace(0.15,1.05,7)
