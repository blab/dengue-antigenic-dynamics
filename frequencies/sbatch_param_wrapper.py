...
beta_vals = np.linspace(0,3,10)
gamma_vals = np.linspace(0,2,10)
sigma_vals = np.linspace(0,3,10)
d2_vals = np.linspace(0,2,10)
d3_vals = np.linspace(0,2,10)
d4_vals = np.linspace(0,2,10)
