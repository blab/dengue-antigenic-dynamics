...
class tree: ## tree class
    ...
    def subtree(self,k=None,subtree=[],traitName=None,converterDict=None, absoluteTime=True):
    ...
    def drawTree(self,order=None,verbose=False):
        ...
        skips=[1 for i in range(len(order))]# if isinstance(x,leaf) else x.width+1 for x in order]
    ...
    def drawUnrooted(self,n=None,total=None):
        ...
        if n==None:
            ...
            total = len([w for w in self.Objects if w.branchType=='leaf'])
